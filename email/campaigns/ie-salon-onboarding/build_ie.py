...
EMAILS=[
 dict(slug="1-welcome", alias="ie-onboarding-1-welcome",
   ...
   rows=lambda:[s_header(), s_hero("hero-kendall.jpg","The celebrity glow, made professional"),
     ...
     s_para(["<strong>Sunless by Jimmy Coco</strong> is the professional spray-tan line from celebrity tanning expert Jimmy Coco &mdash; the believable, undertone-true colour behind red-carpet glow, now available to Irish salons to use in the booth.",
     ...
     s_cta(PRIMARY, PRO_URL, "£60 / 1 litre · professional sample kit · fast delivery to Ireland"),
     s_signoff(), s_footer()]),
 ...
 dict(slug="2-the-formula", alias="ie-onboarding-2-the-formula",
   ...
   rows=lambda:[s_header(), s_hero("product-sunset.jpg","Sunset professional spray tan — 1 litre"),
     ...
     s_para(["The <strong>Sunset professional solution</strong> is the heart of the line &mdash; a one-litre professional spray delivering <strong>25&ndash;30 full-body tans</strong>. Dark / Extra Dark at 10% DHA, undertone-true and buildable, with an even, believable fade.",
     ...
     s_benefits([("Professional spray","engineered for a flawless, even full-body tan."),
                 ("1 litre · 25–30 tans","salon-size value — maximum result from every drop."),
     ...
     s_pricenote("£60 FOR 1 LITRE · PROFESSIONAL GRADE · FAST DELIVERY TO IRELAND"),
     s_signoff(), s_footer()]),
 ...
 dict(slug="5-the-commercial-case", alias="ie-onboarding-5-the-commercial-case",
   ...
   rows=lambda:[s_header(), s_hero("apply-brush.jpg","A premium booth service"),
     ...
     s_para(["In the booth, the professional solution lets you present tanning as a <strong>premium treatment</strong> &mdash; a recognisable name, a believable result, and a genuine reason to price above a standard tan.",
             "At <strong>£60 for a litre that delivers 25&ndash;30 tans</strong>, the maths works firmly in your favour before you&rsquo;ve added a penny of premium to the service."]),
     s_benefits([("Premium service pricing","charge for a celebrity-quality result, not a commodity tan."),
                 ("Salon-size value","25–30 tans per litre keeps your cost per treatment low."),
 ...
 dict(slug="7-become-a-stockist", alias="ie-onboarding-7-become-a-stockist",
   ...
   rows=lambda:[s_header(), s_hero("hero-kendall.jpg","Bring the celebrity tan to your salon"),
     ...
     s_para(["Join selected Irish salons offering the professional spray-tan line your clients already know and trust. The simplest first step is a <strong>professional sample kit</strong> &mdash; trial it on a client and judge the result for yourself."]),
     ...
     s_trust(["FAST DELIVERY TO IRELAND","PROFESSIONAL GRADE","TRUSTED BY 1000+ PROS","MADE FOR RESULTS"]),
     s_signoff(), s_footer()]),
]
...
for e in EMAILS:
    ...
    open(os.path.join(OUT,e["slug"]+".html"),"w").write(html)
