...
- The branded reports live in `public/guides/` (`subject-line-system-report.html`, `how-a-campaign-is-built.html`, `the-production-system.html`) and are embedded in the same view.
