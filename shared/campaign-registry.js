...
export const campaignRegistry = [
  ...
  },
  {
    ...
    name: 'UK Jimmy Coco Pro Recruitment — V2',
    market: 'UK',
    mode: 'sequence',
    classification: 'promotional',
    enabled: false,
    ...
    steps: [
      { key: '01-trial', number: 1, day: 0, templateAlias: 'jc-uk-prospect-01-trial-v2', templateId: 'eba8d19c-55ec-4ee0-b7e4-2f145a02ec0b', subject: 'The tan your clients ask for — now in your treatment room', requiredVariables: ['BUSINESS_NAME', 'BUSINESS_TYPE', 'SENDER_NAME', 'SENDER_TITLE', 'TRIAL_LINK'] },
      { key: '02-result', number: 2, day: 3, templateAlias: 'jc-uk-prospect-02-result-v2', templateId: 'ffdc157c-a2ee-4f85-b286-bf20af24d8a5', subject: 'The details clients notice after their tan', requiredVariables: ['SENDER_NAME', 'SENDER_TITLE', 'TRIAL_LINK'] },
      { key: '03-economics', number: 3, day: 7, templateAlias: 'jc-uk-prospect-03-economics-v2', templateId: '708c8ac6-ef80-4d98-803f-09cc1de9ddda', subject: 'The salon maths behind a premium tan', requiredVariables: ['SENDER_NAME', 'SENDER_TITLE', 'TRIAL_LINK'] },
      { key: '04-retail', number: 4, day: 12, templateAlias: 'jc-uk-prospect-04-retail-v2', templateId: '603bcb34-1e75-44cc-83bd-eca9aea8518c', subject: 'The easiest retail conversation happens after the tan', requiredVariables: ['SENDER_NAME', 'SENDER_TITLE', 'TRIAL_LINK'] },
      { key: '05-close', number: 5, day: 18, templateAlias: 'jc-uk-prospect-05-close-v2', templateId: 'ff9a1c83-db9a-4d46-b544-fb9c542388c2', subject: 'Shall I close this for now?', requiredVariables: ['BUSINESS_NAME', 'SENDER_NAME', 'SENDER_TITLE', 'TRIAL_LINK'] },
    ],
  },
  {
    id: 'us-west-coast-salon-stockist',
    version: '2026-08-17.1',
    name: 'US West Coast Jimmy Coco Pro Recruitment — V2',
    ...
    exitEvents: ['reply', 'trial_requested', 'application_submitted', 'unsubscribe', 'complaint', 'hard_bounce', 'existing_customer', 'ineligible', 'manual_suppression'],
    steps: [
      { key: '01-trial', number: 1, day: 0, templateAlias: 'jc-us-wc-prospect-01-trial-v2', templateId: '8760b944-c87a-46eb-9223-8d24edafb81c', subject: 'A premium spray-tan partnership for {{BUSINESS_NAME}}', requiredVariables: ['BUSINESS_NAME', 'BUSINESS_TYPE', 'SENDER_NAME', 'SENDER_TITLE', 'TRIAL_LINK'] },
      { key: '02-result', number: 2, day: 4, templateAlias: 'jc-us-wc-prospect-02-result-v2', templateId: '2e5cdaeb-1f61-47ce-9b62-4732a154f406', subject: 'Color clients trust in daylight', requiredVariables: ['SENDER_NAME', 'SENDER_TITLE', 'TRIAL_LINK'] },
      { key: '03-retail', number: 3, day: 8, templateAlias: 'jc-us-wc-prospect-03-retail-v2', templateId: '0e3c37f9-31ad-4277-a6fc-75222a29e569', subject: 'One client relationship, two useful revenue moments', requiredVariables: ['SENDER_NAME', 'SENDER_TITLE', 'TRIAL_LINK'] },
      { key: '04-partner-path', number: 4, day: 13, templateAlias: 'jc-us-wc-prospect-04-partner-path-v2', templateId: '55de732a-c2c8-42de-813d-715a1ec1acda', subject: 'A trial-first way to begin', requiredVariables: ['SENDER_NAME', 'SENDER_TITLE', 'TRIAL_LINK'] },
      { key: '05-close', number: 5, day: 19, templateAlias: 'jc-us-wc-prospect-05-close-v2', templateId: 'f4d561b0-cb75-43b5-bdc3-f035068ce8fa', subject: 'Shall I close this for now?', requiredVariables: ['BUSINESS_NAME', 'SENDER_NAME', 'SENDER_TITLE', 'TRIAL_LINK'] },
    ],
  },
  {
