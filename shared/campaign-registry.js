...
export const campaignRegistry = [
  ...
  },
  {
    ...
    steps: [
      ...
      { key: '04-retail', number: 4, day: 12, templateAlias: 'jc-uk-prospect-04-retail-v2', templateId: '603bcb34-1e75-44cc-83bd-eca9aea8518c', subject: 'The retail moment is when the client sees the result', requiredVariables: ['SENDER_NAME', 'SENDER_TITLE', 'TRIAL_LINK'] },
