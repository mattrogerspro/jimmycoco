...
function FeatureIcon({ name }: { name: string }) {
  return <span className={`feature-icon feature-icon--${name}`} aria-hidden="true">
    {name === "spray" ? <svg viewBox="0 0 48 48" fill="none" stroke="currentColor" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round"><path d="M17 25h8a4 4 0 0 1 4 4v11H13V29a4 4 0 0 1 4-4Z" /><path d="M18.5 25v-6h7V25" /><path d="M25.5 20h8l4 3" /><path d="M10 31H5" /><path d="M35 13h7M35 19h8M35 25l7 3" /></svg> : null}
    {name === "bottle" ? <svg viewBox="0 0 48 48" aria-hidden="true"><path d="M19 9h10v7c0 2.2.8 3.4 2.1 4.8 2.2 2.3 3.4 4.8 3.4 8.2v13.5c0 2.5-1.8 4.5-4.2 4.5H17.7c-2.4 0-4.2-2-4.2-4.5V29c0-3.4 1.2-5.9 3.4-8.2C18.2 19.4 19 18.2 19 16V9Z" fill="currentColor" /><rect x="18" y="4" width="12" height="6" rx="2" fill="currentColor" /></svg> : null}
    {name === "body" ? <svg viewBox="0 0 48 48" fill="none" stroke="currentColor" strokeWidth="2.6" strokeLinecap="round" strokeLinejoin="round"><circle cx="23" cy="12.5" r="5.5" /><path d="M8 45c0-11 6.5-19.5 15-19.5S38 34 38 45" /><path d="M23 26v18" /><path d="M38 8.5l1.7 4.2 4.2 1.7-4.2 1.7-1.7 4.2-1.7-4.2-4.2-1.7 4.2-1.7z" fill="currentColor" stroke="none" /></svg> : null}
  </span>;
}
...
export function Story() {
  return <section id="story"><div className="wrap story-grid">
    <img src={`${A}jimmy-coco-story-580.webp`} srcSet={`${A}jimmy-coco-story-460.webp 460w, ${A}jimmy-coco-story-580.webp 580w, ${A}jimmy-coco-story-760.webp 760w`} sizes="(max-width: 900px) 100vw, 42vw" alt="Jimmy Coco — the Hollywood tan artist behind the Sunless professional range" width="760" height="932" loading="lazy" decoding="async" />
...
export function Shades() {
  ...
  const specs = [
    ["spray", "Professional spray tan", "Designed for a flawless full body tan"],
    ["bottle", "1 Litre · 33.81 fl.oz.", "Salon size for maximum value"],
    ["body", "Approx. 28", "Full body tans per bottle"],
  ];
  const facts = specs;
  return <>
