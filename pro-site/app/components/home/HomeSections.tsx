...
export function Story() {
  return <section id="story"><div className="wrap story-grid">
    <img src={`${A}jimmy-coco-story-760.webp`} srcSet={`${A}jimmy-coco-story-460.webp 460w, ${A}jimmy-coco-story-580.webp 580w, ${A}jimmy-coco-story-760.webp 760w`} sizes="(max-width: 900px) 100vw, 42vw" alt="Jimmy Coco — the Hollywood tan artist behind the Sunless professional range" width="760" height="932" loading="lazy" decoding="async" />
