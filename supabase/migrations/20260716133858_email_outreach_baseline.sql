...
values
  ...
  ('au-salon-account-flow','sample-check-in',1,null,'sample_dispatched','au-account-1-sample-check-in','ac587ebf-d58c-42bd-901b-edb239369b3d','lifecycle','How did the Malibu tan turn out?','["SALON_NAME","CALENDAR_LINK","SENDER_NAME","SENDER_TITLE","BUSINESS_ADDRESS"]'),
