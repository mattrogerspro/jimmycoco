...
| UK reseller lifecycle (application → account) | [`uk-reseller-lifecycle/`](uk-reseller-lifecycle/) | Email (Resend) | 🇬🇧 UK | Draft — not approved for send | Trade application to open account |
