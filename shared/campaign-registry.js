...
export const campaignRegistry = [
  ...
  },
  {
    ...
    name: 'UK Jimmy Coco Pro Recruitment — V2 — Seven Email',
    market: 'UK',
    mode: 'sequence',
    classification: 'promotional',
    enabled: false,
    ...
    steps: [
      { key: '01-trial', number: 1, day: 0, templateAlias: 'jc-uk-prospect-01-trial-v2', templateId: 'eba8d19c-55ec-4ee0-b7e4-2f145a02ec0b', subject: 'A premium tan service — and a second revenue moment after the appointment', requiredVariables: ['BUSINESS_NAME', 'BUSINESS_TYPE', 'SENDER_NAME', 'SENDER_TITLE', 'TRIAL_LINK'] },
      { key: '02-result', number: 2, day: 3, templateAlias: 'jc-uk-prospect-02-result-v2', templateId: 'ffdc157c-a2ee-4f85-b286-bf20af24d8a5', subject: 'The result is what gives a premium tan its value', requiredVariables: ['SENDER_NAME', 'SENDER_TITLE', 'TRIAL_LINK'] },
      { key: '03-economics', number: 3, day: 7, templateAlias: 'jc-uk-prospect-03-economics-v2', templateId: '708c8ac6-ef80-4d98-803f-09cc1de9ddda', subject: '£2.14 in solution cost is only the start of the salon maths', requiredVariables: ['SENDER_NAME', 'SENDER_TITLE', 'TRIAL_LINK'] },
      { key: '04-retail', number: 4, day: 13, templateAlias: 'jc-uk-prospect-04-retail-v2', templateId: '603bcb34-1e75-44cc-83bd-eca9aea8518c', subject: 'The retail moment is when the client sees the result', requiredVariables: ['SENDER_NAME', 'SENDER_TITLE', 'TRIAL_LINK'] },
      { key: '06-process', number: 5, day: 21, templateAlias: 'jc-uk-prospect-06-process-v2', templateId: 'fe598cad-a067-4d1a-8416-55b4d75b298e', subject: 'What happens after you request the trial?', requiredVariables: ['SENDER_NAME', 'SENDER_TITLE', 'TRIAL_LINK'] },
      { key: '07-choice', number: 6, day: 32, templateAlias: 'jc-uk-prospect-07-choice-v2', templateId: '0eb5e875-776e-4dbc-a791-5588e622066b', subject: 'Would numbers or retail be more useful?', requiredVariables: ['SENDER_NAME', 'SENDER_TITLE', 'TRIAL_LINK'] },
      { key: '05-close', number: 7, day: 45, templateAlias: 'jc-uk-prospect-05-close-v2', templateId: 'ff9a1c83-db9a-4d46-b544-fb9c542388c2', subject: 'Shall I close this for now?', requiredVariables: ['BUSINESS_NAME', 'SENDER_NAME', 'SENDER_TITLE', 'TRIAL_LINK'] },
    ],
  },
  {
    ...
    steps: [
      ...
      { key: '06-process', number: 5, day: 21, templateAlias: 'jc-us-wc-prospect-06-process-v2', templateId: 'fd62292a-a7ba-4c69-a8b0-f0db0533584f', subject: 'What happens after you request information?', requiredVariables: ['SENDER_NAME', 'SENDER_TITLE', 'TRIAL_LINK'] },
      ...
      { key: '05-close', number: 7, day: 45, templateAlias: 'jc-us-wc-prospect-05-close-v2', templateId: 'f4d561b0-cb75-43b5-bdc3-f035068ce8fa', subject: 'Shall I close this for now?', requiredVariables: ['BUSINESS_NAME', 'SENDER_NAME', 'SENDER_TITLE', 'TRIAL_LINK'] },
    ],
  },
  {
