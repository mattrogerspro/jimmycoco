...
export function Shades() {
  ...
  return <>
    <section className="shades-showcase" id="shades"><div className="wrap">
      ...
      <div className="shade-intro"><span className="shade-rule" /><p>Our three signature shades are custom-blended to deliver a natural, believable glow — for every skin tone.</p></div>
...
export function Retail() {
  const products = [
    ...
    ["home-11-d075d24d746f.jpg", "The Self Tan Soufflé with mitt and face mist bundle", "The top-up seller", "The Self Tan Soufflé", "Instant tint, Jimmy's iconic scent and a moisture-locking formula — the take-home that extends your work between appointments.", "Medium · Dark", ""],
